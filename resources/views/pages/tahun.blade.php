                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambahtahun">
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>2024/2025</td>
                                        <td>
                                            <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#editth">
                                                <i class="fa fa-pencil-alt" aria-hidden="true"></i>
                                                edit
                                            </button>
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteth">
                                    ...
                                    <!-- Edit Modal -->
                                    <div class="modal fade" id="editth">
                                    ...
                                    <!-- Delete Modal -->
                                    <div class="modal fade" id="deleteth">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
